...
public class RobotMap {
    ...
    public static final int HATCH_FORWARD = 5;
    public static final int HATCH_BACKWARD = 3;
    public static final int RAISE_HATCH = 6;
    public static final int LOWER_HATCH = 4;
